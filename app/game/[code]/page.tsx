        ...
        {[trackA, trackB].map((track) =>
          track ? (
            <div key={track.id} className="flex flex-col items-center">
              ...
              ></iframe>
              <button
                className={`rounded bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 font-semibold  mt-2 w-full max-w-xs ${
                  hasVoted || !!winner ? "opacity-50 cursor-not-allowed" : ""
                }`}
